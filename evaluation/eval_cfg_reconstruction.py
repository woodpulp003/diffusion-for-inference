# -*- coding: utf-8 -*-
"""
Evaluation script for CFG conditional diffusion: Recover W from A_obs.
...
This is the primary evaluation for Phase 4: amortized warm-start inference.
"""
...
def main(
    ...
    if output_dir is None:
        output_dir = "evaluation/reconstruction_results"
...
def create_arg_parser():
    ...
    parser = argparse.ArgumentParser(
        description="Evaluate CFG reconstruction: Recover W from A_obs",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Output directory for saving predictions (default: evaluation/reconstruction_results)",
    )
